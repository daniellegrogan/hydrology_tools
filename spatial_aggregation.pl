...
my ($help,$verbose,$zID,$remove,$remove_mask,$rm_rec,$s_date,$e_date,$tr,$na,
	$cumulative, $mdt,$type,$m_file,$MT_file) =
(     0,      0,    0,     0,         0,        0,      '',     '',   0,  0,
	     0,       '',   '',    '',     ''   );
						# Get command line options
usage() if !GetOptions('h'=>\$help, 'v'=>\$verbose, 'z'=>\$zID, 'rm'=>\$remove, 'rmsk'=>\$remove_mask, 'rr=i'=>\$rm_rec, 'sd=s'=>\$s_date, 'ed=s'=>\$e_date, 'tr=f'=>\$tr, 'na=f'=>\$na, 'c'=>\$cumulative, 'mdt=s'=>\$mdt, 'ot=s'=>\$type, 'f=s'=>\$m_file, 'mt=s'=>\$MT_file) or $help;
